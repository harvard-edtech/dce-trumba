...
var initTrumbaAPI = function (auth) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios.get("http://www.trumba.com/calendars/".concat(webName, ".json"), { params: params })];
                case 1:
                    data = (_d.sent()).data;
    ...
    var registerForEvent = function (registration) { return __awaiter(void 0, void 0, void 0, function () {
        var eventId, name, email, status, eventTitle, formAnswers, request, data, err_2, responseData;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios.put('https://www.trumba.com/api/v2/attendees', request, { auth: auth })];
                case 2:
                    data = (_b.sent()).data;
                    return [2 /*return*/, data];
                case 3:
    ...
    var listAttendees = function (query) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios.get('https://www.trumba.com/api/v2/attendees', {
                            params: params,
                            auth: auth
                        })];
                case 2:
