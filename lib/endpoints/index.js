...
var initTrumbaAPI = function (auth) {
    ...
    * @param {TrumbaEventFilter} [filter] EventFilter for narrowing the results of the list events
     *   search
    ...
    var listEvents = function (webName, filter) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, numEvents, eventIds, startDate, endDate, months, weeks, days, previousWeeks, filterView, search, html, customNotes, params, response, err_1, responseData;
        var _b, _c;
    ...
    * @param registration object containing registration information
